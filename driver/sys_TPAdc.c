...
/* unsigned char F1C_TP_Scan(unsigned char tp)
{
	...
	if (as & 0x2) //抬起
	{
		//sys_TPAdc_debug("TP_CTRL_REG0=0x%08x\r\n",as);
		// sys_TPAdc_debug("TP UP...\r\n");
...
void ADC_MODE_Demo(void)
{
	...
	Set_ADC_Channel(ADC_all);
	sys_TPAdc_debug("TP_CTRL_REG0=0x%08x\r\n", read32(TP_CTRL_REG0));
	sys_TPAdc_debug("TP_CTRL_REG1=0x%08x\r\n", read32(TP_CTRL_REG1));
	sys_TPAdc_debug("TP_CTRL_REG2=0x%08x\r\n", read32(TP_CTRL_REG2));
	sys_TPAdc_debug("TP_CTRL_REG3=0x%08x\r\n", read32(TP_CTRL_REG3));
	while (1)
	{
		//等待FIFO满
		// i = Read_time_ms(); note
		...
		_y2 /= 4;
		//
		//		sys_TPAdc_debug("x1=%d\r\n",_x1);
		//		sys_TPAdc_debug("x2=%d\r\n",_x2);
		//		sys_TPAdc_debug("y1=%d\r\n",_y1);
		//		sys_TPAdc_debug("y2=%d\r\n",_y2);
		/*x1-按键处理*/
