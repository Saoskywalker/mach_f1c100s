...
***********************************************************************************/
u32 *defe_buf_addr = NULL; //用于defe的硬件缩放系统的数据输入地址 
...
{
    Defe_Init();
    Defe_Config_layer_scale(inx, iny, fb_f1c100s_pData.width, fb_f1c100s_pData.height);
    Defe_Start();
}
...
// #ifdef	LCD_TYPE_RGB43_480_272
	...
	if(inmode==TVD_SOURCE_NTSC)
		Defe_Config_video_uvcombined_yuv422_to_argb(720,480,fb_f1c100s_pData.width,fb_f1c100s_pData.height);
	else	if(inmode==TVD_SOURCE_PAL)
		Defe_Config_video_uvcombined_yuv422_to_argb(720,576,fb_f1c100s_pData.width,fb_f1c100s_pData.height);	
#endif
